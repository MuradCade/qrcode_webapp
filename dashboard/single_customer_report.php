...
>
  <head>
    ...
    <title>Dashboard | Single Customer Report</title>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="single_customer_report.php?logout=true">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <div class="card">
                        <h4 class="card-header" style="font-size:17px; color:black !important;">Generate Single Customer Report</h4>
                        <div class="card-body">
                         <div class="row">
                               <!-- from date -->
                        ...
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="phoneNumber" style="text-transform:none !important; font-size:13.5px; letter-spacing:0.5px; color:black; font-weight:600;">Customer Phone Number</label>
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $phone = $_POST['phone'];
                              if(empty($phone)){?>
                              <script>
                                alert('Empty Customer Phone Field');
                              </script>
                              <?php } 
                            ?>
                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                              <input type="text" id='totalprice' value='<?php if($rows['currency_type'] == 'shilling'){
                                echo $rows['price'];
                              }
                                ...
                                ?>' style="border:none; outline:border;">
                            ...
                            <?php  $num++;}}}else{
                                echo "<h5 style='font-size:14px' class='fw-bold'>data not found for specified customer phone number</h5>";
                            }}} ?>
                             <tfoot>
                                  <tr>
