                      ...
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">
                            Welcome Back Goljano Resurant! 🎉
                          </h5>
                          <p class="mb-4">
                            welcome to your dashboard where you have ability to
                            track your<span class="fw-bold"></span>
                              bussiness progress</span
                            >
                            and more about your customers needs.
                          </p>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h3 class="card-title mb-2"><?php if($result){
              ...
              >
                ...
                <div>
                  ...
                  <a
                    ...
                    target="_blank"
                    class="footer-link me-4" style="font-weight:600 ;"
                    >Customer Support</a
                  >
                </div>
              </div>
