...
if(isset($_POST['submit'])){
  ...
  $id = $_POST['id'];
  if(empty($pwd)){
    header('location:/dashboard/change_pwd.php?inputerror');
    die();
  }else{

    $sql = "update restinfo set pwd = '$pwd' where id = '$id'";
    $result = mysqli_query($conn,$sql);
    if($result){
      header('location:change_pwd.php?success');
      die();
    }else{
      header('location:change_pwd.php?error');
      die();
    }
  }
}
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="change_pwd.php?logout=true">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <?php if(isset($_GET['success'])){?>
                        ...
                        <p class="bg-success p-2 text-white fw-bold">Password Changed Successfully</p>
                        <?php }else if(isset($_GET['error'])){?>
                          <p class="bg-danger p-2 text-white fw-bold">Password Failed To Change</p>
                          <?php } 
                        else if(isset($_GET['inputerror'])){?>
                          <p class="bg-danger p-2 text-white fw-bold">Empty Password Feild</p>
                          <?php } ?>
                      <form id="formAccountSettings" method="POST">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text"  name="id" value="60932220" readonly/>
                          </div>
