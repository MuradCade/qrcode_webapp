...
if(isset($_POST['submit'])){
  ...
  if(empty($tablename)){?>
      <script>
        alert('Empty Table Name');
      </script>
  <?php }else{
$sql = "update tables set tablename = '$tablename' where id = '$id'";
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="update_table_number.php?logout=true">
                  ...
                  <div class="card">
                    ...
                    <div class="container mb-2">
                        ...
                        <div class="form-group mt-2">
                            <label class="form-label" style="text-transform: none; font-size:14px; font-weight:600 !important;">Table Name</label>
                            <input type="number" class="form-control" placeholder="Enter Table Name" name="tablename" value="<?= $row['tablename']?>">
                        </div>
                        
                        <div class="text-start mt-2 mb-2">
                            <button class="btn  btn-primary fw-bold" name="submit">Submit</button>
                            <a href="/dashboard/view_tables.php" class="btn btn-secondary">Cancel</a>
                        </div>
                        <?php }} ?>
                    </form>
                    </div>
