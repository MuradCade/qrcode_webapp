...
if(isset($_GET['del'])){
  $delid = $_GET['del'];
  $sql = "DELETE FROM foodmenu  WHERE id = '$delid'";
...
>
  <head>
    ...
    <title>Dashboard | View Menu</title>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="menu.php?logout=true">
              ...
              <div class="row">
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="Container"  style="display:flex; align-items:center; justify-content:space-between;margin-bottom:10px">
                        <a href="add_new_menu.php" class="btn btn-primary">Add New</a>
                        <input
                        type="text"
                        style="
                            ...
                            <tr>
                              ...
                              <td>
                                <li
                                  ...
                                  title="<?php echo $row['foodname']?>"
                                  style="list-style: none"
                                >
                                  <img
                                    src="upload_images/<?php echo $row['foodimage'];?>"
                                    alt="food-image"
                                  />
                                </li>
                              </td>
                              <td><p><?php echo $row['foodname'];?></p></td>
                              <td>
                                <p class="text-wrap"><?php echo $row['fooddesc'];?></p>
                              </td>
                              
                              <td>
                                <p style="color: #697a8d; font-weight: bold">
                                <?php echo  $row['currency_type']== 'dollar'? '$':'';?><?php echo number_format( $row['price']);?><?php echo  $row['currency_type'] == 'shilling'?'sh':'';?>
                                </p>
                              </td>
                              <td>
                                <p class="text-wrap"><?php echo $row['category'];?></p>
                              </td>
                              <td>
                                <p class="text-wrap"><?php echo $row['food_status'];?></p>
                              </td>
                              <td>
                                <a href = "data/update_menu_item.php?id=<?php echo $row['id'];?>" class="btn btn-primary">Update</a>
                                <a href = "menu.php?del=<?= $row['id']?>" class="btn btn-danger">Delete</a>
                              </td>
                            </tr>
