...
>
  <head>
    ...
    <title>Dashboard | Add New Table</title>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="add_new_table.php?logout=true">
                  ...
                  <div class="card">
                    ...
                    <div class="container mb-2">
                      <?php if(isset($_GET['success'])){
                        ?>
                      <p class="bg-success text-white p-2 fw-bold">New Room Name Added Successfully</p>
                      <?php } else if(isset($_GET['error'])){?>
                      <p class="bg-danger text-white p-2 fw-bold">Failed To Add Room Name</p>
                      <?php } else if(isset($_GET['inputerror'])) { ?>
                        <p class="bg-danger text-white p-2 fw-bold">Empty Room Name Field</p>
                        <?php } ?>
                        <form method="POST" action="data/add_table_number.php">
                    
                      <div class="form-group mt-2">
                        <label class="form-label" style="text-transform: none; font-size:14px; font-weight:600 !important;">Room Name</label>
                        <input type="number" class="form-control" placeholder="Enter Room Name" name="tablename">
                      </div>
