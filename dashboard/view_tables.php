...
// delete table name from db 
if(isset($_GET['del'])){
  $delid = $_GET['del'];
  $sql = "delete from tables where id = '$delid'";
...
<?php }else{?>
<script>
        alert('Table Name Failed To Delete');
        window.location.href = 'view_tables.php';
    </script>
<?php }
}
...
>
  <head>
    ...
    <title>Dashboard | View Table</title>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="view_tables.php?logout=true">
              ...
              <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="Container"  style="display:flex; align-items:center; justify-content:space-between;margin-bottom:10px">
                        <a href="add_new_table.php" class="btn btn-primary">Add New</a>
                        <input
                        type="text"
                        style="
                      ...
                      <div class="table-responsive text-nowrap">
                        <table class="table table-bordered" id="myTable">
                          ...
                          <?php
                          // fecth data from db and display it in table
                          ...
                          <tr>
                            <td><?= $num;?></td>
                            <td><p><?= 'Room '.$row['tablename'];?></p></td>
                            <td>
                              <p class="text-wrap"><?= $row['created_at']?></p>
                            </td>
                            <td>
                              <a href="data/update_table_number.php?id=<?= $row['id']; ?>" class="btn btn-primary">Update</a>
                              <a  href="view_tables.php?del=<?= $row['id'];?>" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
                          <?php  
