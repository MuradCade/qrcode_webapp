...
if(isset($_GET['orderid'])){
  ...
  // update db called foodorder
    $sql = "UPDATE  foodorder SET complete_order = 'Accepted' where id  = '$orderid'";
    $result  = mysqli_query($conn,$sql);
    if($result){?>
      <script>
        alert('Dalabka Waa La Aqbalay');
        window.location.href = 'view_order.php';
      // </script>
    <?php }else{?>
      <script>
        alert('Wan Ka Xunahay Dalbka Wa La Aqbali Kari Wayay');
        window.location.href = 'view_order.php';
      </script>
    <?php }
...
if(isset($_GET['cancel'])){
  ...
  // update db called foodorder
    $sql = "UPDATE  foodorder SET complete_order = 'Cancelled' where id  = '$orderid'";
    $result  = mysqli_query($conn,$sql);
    if($result){?>
      <script>
        alert('Dalabka Waa La Aqbali Wayay');
        window.location.href = 'view_order.php';
      // </script>
    <?php }else{?>
      <script>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="view_order.php?logout=true">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                      <a href='print_paper.php' class="btn btn-primary">generate Invoice paper</a>
                      ...
                      <div class="table-responsive text-nowrap">
                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                              <p class="text-wrap"><?php if($rows['currency_type'] == 'shilling'){
                                echo number_format($rows['price']).'sh';
                              }
                              ...
                              <td>
                               <?php
                               if($row['complete_order'] == "waiting"){?>
                               <a href="view_order.php?orderid=<?= $row['id']?>" class="btn btn-success">Accept</a>
                                <a href="view_order.php?cancel=<?= $row['id']?>" class="btn btn-danger">Decline</a>
                              <?php } else if($row['complete_order'] == "Accepted"){?>
                                <span class="bg-success text-white d-block p-2 fw-bold rounded text-center">Order Accepted</span>
                                <?php }  else if($row['complete_order'] == "Cancelled"){?>
                                  <span class="bg-danger text-white d-block p-2 fw-bold rounded">Order Cancelled</span>
                                <?php }?>
                              </td>
                            </tr>
                            <?php  $num++;}}}}?>
