...
>
  <head>
    ...
    <title>Dashboard | Add New Item</title>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="add_new_menu.php?logout=true">
                  ...
                  <div class="card">
                    ...
                    <div class="container mb-2">
                      <?php  if(isset($_GET['sucess'])){?>
                        <p class="bg-success p-2 text-white fw-bold">Added New Item Successfully</p>
                        <?php } else if(isset($_GET['dbfail'])){?>
                          <p class="bg-danger p-2 text-white fw-bold">Failed To Add New Item</p>
                          <?php } else if(isset($_GET['error'])){?>
                            <p class="bg-danger p-2 text-white fw-bold">Failed To Add New Item</p>
                           <?php } else if(isset($_GET['errorinput'])) { ?>
                        <p class="bg-danger text-white p-2 fw-bold">Please Fill The Form Field</p>
                        <?php } 
                             else if(isset($_GET['errorimg'])) { ?>
                        <p class="bg-danger text-white p-2 fw-bold">Added New Item, But Image Already Exisist</p>
                        <?php } ?>
                        <form  method="POST" action="data/add_new_item.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Food Name" name="foodname"/>
                      </div>
                      <div class="form-group mt-2">
                        ...
                        <textarea class="form-control" cols="10" rows="4" placeholder="Food Description" name="fooddesc"></textarea>
                      </div>
                      <div class="form-group mt-2 mb-3">
                        <label class="form-label" style="text-transform: none; font-size:14px; font-weight:600 !important;">Food Category</label>
                        <select name="category" class="form-select" placeholder="Enter Food Price">
                      ...
                      <div class="form-group mt-2 mb-3">
                        ...
                        <input type="number" name="foodprice" class="form-control" placeholder="Enter Food Price">
                      </div>
                      <div class="form-group mt-2 mb-3">
                        <label class="form-label" style="text-transform: none; font-size:14px; font-weight:600 !important;">Money Type</label>
                        <select name="currency" class="form-select" placeholder="Enter Food Price" >
