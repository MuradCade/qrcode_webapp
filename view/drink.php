...
$sql = "SELECT * FROM foodmenu where category = 'drink'";
...
<div class="heading">
  ...
  <div class="food-category">
    <a href="menu.php" class=" btn  btn-secondary ml-2">Food</a>
    <a href="drink.php" class="btn btn-primary ml-2">Drink</a>
</div>
<div class="menu">
    <div class="menu-column">
        ...
        <?php if($row['food_status'] == 'U Dhamaday'){ ?>
            ...
            <p><?= $row['fooddesc'];?></p>
            <form action="drink.php?foodid= <?=  isset($_SESSION['id'])? $row['id']:'0' ?>&food_status=<?= $row['food_status'];?>" method="POST">
...
<div class="wrapper">
    <div class="popup">
        ...
        <form class="form-content" method="GET" action="drink.php">
    ...
    <?php 
      if(isset($_GET['food_status'])){
        ...
        if($foodstatus == 'U Dhamaday'){?>
            ...
            <script>
                alert('Macmill Sharaabka Aad Dalbanaysid Uu Dhamaday, Fadlan Sharab Kale Dooro');
